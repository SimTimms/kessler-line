...
interface RunPrimaryPhysicsFrameParams {
  ...
  dockedTo: RefObject<string | null>;
  didApplyInitialVelocity: RefObject<boolean>;
  initialVelocity?: [number, number, number];
  velocity: RefObject<THREE.Vector3>;
  angularVelocity: RefObject<number>;
  angularVelocity3: RefObject<THREE.Vector3>;
  physicsPosition: RefObject<THREE.Vector3>;
  primaryGravityId: RefObject<string | null>;
  ...
  stabilizerActive: RefObject<boolean>;
  destroyedFired: RefObject<boolean>;
  destroyedSpinSet: RefObject<boolean>;
  ...
  dockReentryBlock?: RefObject<string | null>;
  dockingPortDisabledUntil?: RefObject<number>;
}
