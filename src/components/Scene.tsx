...
import EarthAsteroidRing from './Earth/EarthAsteroidRing';
...
import CinematicController from './Cinematic/CinematicController';
import AutopilotController from './AutopilotController';
import NeptuneNoFlyRing from './Neptune/NeptuneNoFlyRing';
