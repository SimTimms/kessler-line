...
export const TUTORIAL_STEPS: TutorialResourcesStep[] = [
  ...
  {
    id: TUTORIAL_STEP_IDS.SPOTLIGHT,
    title: 'Spotlight',
    prompt: `You can use the spotlight to scan the area for resources and dangers. Spotlight uses power and it has a variable range depending on how much power you assign to it. Use Spotlight sparingly, but it's a good idea to have at least some spotlight on at all times.    `,
    keys: [],
    completionCriteria: { type: 'continue' },
    continueLabel: 'Continue',
  },
  ...
  {
    id: TUTORIAL_STEP_IDS.POWER_LEVELS,
    title: 'Power Level',
    prompt: `You can use the power level to set the range of your scanners and spotlight.`,
    keys: [],
    completionCriteria: { type: 'continue' },
    continueLabel: 'Continue',
  },
  {
    id: TUTORIAL_STEP_IDS.G_FORCE,
    title: 'G-Force',
    prompt: `You can use the g-force to see how much g-force you are experiencing. Turn on the g-force and you'll see your g-force on your HUD to avoid blacking out. `,
    keys: [],
    completionCriteria: { type: 'continue' },
    continueLabel: 'Continue',
  },
  {
    id: TUTORIAL_STEP_IDS.TRY_SCANNERS,
    title: 'Try Scanners',
    prompt: `Try using the scanners to scan the area for resources and dangers.`,
    keys: [],
    completionCriteria: { type: 'continue' },
    continueLabel: 'Continue',
  },
