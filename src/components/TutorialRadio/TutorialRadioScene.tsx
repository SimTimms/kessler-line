...
import {
  TUTORIAL_BATTLESHIP_RADIO_BROADCAST,
  TUTORIAL_RADIO_BROADCAST,
} from './tutorialRadioConfig';
import BattleshipBritish from '../BattleshipBritish/BattleshipBritish';
import {
  TUTORIAL_BATTLESHIP_ORBIT,
  TUTORIAL_BATTLESHIP_SCAN,
} from '../../config/battleshipScanConfig';
      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          <ContainerBritish
            ...
            radioBroadcast={TUTORIAL_RADIO_BROADCAST}
            scale={10}
            position={[400, 0, 100]}
          />
          <BattleshipBritish
            ...
            orbit={TUTORIAL_BATTLESHIP_ORBIT}
          />
        </Suspense>
        {/*  <CollisionDebug /> */}
