...
export const DOCKING_PORT_LOCAL_Z = 9; // local +Z from ship center to nose port
...
export function setPower(v: number) { power = v; }
export function setFuel(v: number) { fuel = v; }
export function setO2(v: number) { o2 = v; }
